...
(function (window, document, $) {
	...
	$.extend(F, {
		...
		defaults: {
			...
			fixed: !navigator.userAgent.match(/msie [6]/i) || $.browser.version > 6,
			...
			tpl: {
				...
				iframe: '<iframe class="fancybox-iframe" name="fancybox-frame{rnd}" frameborder="0" hspace="0" ' + (navigator.userAgent.match(/msie [6]/i) ? 'allowtransparency="true""' : '') + ' scrolling="{scrolling}" src="{href}"></iframe>',
